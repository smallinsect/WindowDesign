...
void WMCommand(HWND hWnd, UINT Msg, WPARAM wParam, LPARAM lParam){
	...
	sprintf(szNum, TEXT("%63.2lf"), num);
	TextOut(hdc, cxChar*WIDTH * 10, cyChar, szExpression, lstrlen(szExpression));
	TextOut(hdc, cxChar*WIDTH * 10, cyChar * 2, szNum, lstrlen(szNum));
